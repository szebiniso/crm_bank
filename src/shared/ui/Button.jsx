...
const Button = ({type, text, loading, disabled= false, toolExist, tooltipText}) => {
  return (
    <>
      <button type={type}
              disabled={disabled}
        ...
        {toolExist && disabled && <span className="button-tooltip group-hover:scale-100">
          Для создания необходимо заполнить все поля <br/>
          организации и администратора!
        </span>}
      </button>
    </>
  );
