...
const IterationsContainer = () => {
  ...
  // useEffect(() => {
  //   dispatch(getTasks(activeIterationId))
  ...
  return (
    <>
      <div className='mb-8 bg-container-bg rounded-xl'>
        <div className='text-gray-200 text-lg font-bold flex justify-between items-center border border-gray-800 rounded-t-xl'>
        ...
        <div className='flex w-full border border-gray-800 h-[400px] rounded-b-xl '>
          <div className='m-2 w-1/2 rounded-xl relative'>
            ...
            {
              role === 'Менеджер' && <button onClick={() => setCreateFormModal(true)} className='w-[97%] bg-[#182434] rounded border border-blue-900 text-blue-400 p-2 m-2 absolute bottom-0 cursor-pointer'>Создать итерацию</button>
            }
          ...
          <div className='m-2 w-1/2'>
            <IterationTasksContainer activeIterationId={activeIterationId} iteration_id={iterationId}/>
          </div>
        </div>
      </div>
